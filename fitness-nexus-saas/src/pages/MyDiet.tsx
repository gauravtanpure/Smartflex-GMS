...
export default function MyDiet() {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen font-poppins">
      <h2 className="text-3xl font-extrabold text-gray-800 mb-6 text-center">My Diet Plans</h2>
      {dietPlans.length === 0 ? (
        <p className="text-gray-600 text-center text-lg">No diet plans assigned to you yet. Check back later!</p>
      ) : (
